Implementing k-means clustering to cluster together a sample of user descriptions from Twitter. These are a somewhat random sample of 10,000 user profiles. They have already been tokenized.
